...
public class Contato extends Entidade{
    ...
    public Contato(Integer id) {
        try {
            Contato coBd = this.busca(id);
            setId(id);
            setNome(coBd.getNome());
            setTelefone(coBd.getTelefone());
            setTelefone2(coBd.getTelefone2());
            setCelular(coBd.getCelular());
            setCelular2(coBd.getCelular2());
            setEmail(coBd.getEmail());
